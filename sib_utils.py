...
STOP_WORDS = {'a', 'about', 'all', 'also', 'am', 'an', 'and', 'any', 'are', 'as', 'at', 'be', 'being', 'been',
              ...
              "get", "tell", "anyone", "19", "find", "need", "know"
              }
...
def custom_tokenizer(text, use_stemmer):
    text = text.lower()
...
def text_processor(text, use_stemmer):
    return ' '.join(custom_tokenizer(text, use_stemmer))
